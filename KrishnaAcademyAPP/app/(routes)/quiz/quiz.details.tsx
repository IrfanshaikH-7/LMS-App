...
export default function QuizScreen() {
  ...
  return (
    ...
    >
      <View>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 4 }}>
            ...
            />
            <Text style={{ fontWeight: '800', fontSize: 14 }} >{"01:23:50"}</Text>
          </View>
          <Button onPress={() => setScoreModalVisible(true)} title="submit" color={'red'}></Button>
        </View>
        <View style={{ width: "100%", height: 1, backgroundColor: '#D3D4DB' }} />
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8, position: 'relative' }}>
          <TouchableOpacity style={{ paddingVertical: 6, paddingHorizontal: 16, backgroundColor: 'red', width: 80, alignItems: 'center', }} onPress={toggleLanguage}>
            <Text style={{ fontWeight: '800', fontSize: 12, color: 'white' }}>{language === 'english' ? 'English' : 'Hindi'}</Text>
          </TouchableOpacity>
          <Animated.View
            style={{
              position: 'absolute',
          ...
          >
            <TouchableOpacity onPress={handleMenuPress}>
              {/* TODO: change to default bg color */}
              <Ionicons
                style={{ alignSelf: 'center', position: 'absolute', left: -60, backgroundColor: '#e2e2e2', padding: 4 }}
                name="menu"
                size={24}
                color={'black'}
                zIndex={999}
      ...
      {/* {  -- Questions mapping  --} */}
      <ScrollView stickyHeaderIndices={[0]} style={{ flex: 1, marginTop: 12 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ backgroundColor: 'white' }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
              <Ionicons style={{ alignSelf: 'center' }} name="alert-circle-outline" size={20} color={'black'} />
              <MaterialCommunityIcons style={{ alignSelf: 'center' }} name="timer" size={20} color="black" />
              <Text style={{ fontSize: 13 }}>{'40:02'}</Text>
            </View>
          </View>
        </View>
        <View style={{ flex: 1, marginTop: 20 }}>
          <Text style={{ fontWeight: '800' }}>{"SECTION A : ENGLISH LANGUAGE"}</Text>
      ...
      >
        <View style={{
          ...
          <View style={{
            ...
            <Text style={{ fontSize: 16, fontWeight: '800', textAlign: 'left' }}>Score Card</Text>
            <View style={{paddingHorizontal:24, gap:8}}>
              <View style={{flexDirection:'row', justifyContent:'space-between',borderBottomColor:'#e2e2e2', borderBottomWidth:1,width:'100%',}}>
                <View style={{flexDirection:'row', gap:3}}>
                <MaterialCommunityIcons style={{ alignSelf: 'center' }} name="timer" size={20} color="black" />
                <Text style={{fontSize: 14,color:'gray'}}>Time left</Text>
                </View>
                <Text style={{fontSize: 14,color:'gray'}}>{"00:28:31"}</Text>
              ...
              <View style={{flexDirection:'row', justifyContent:'space-between',borderBottomColor:'#e2e2e2', borderBottomWidth:1,width:'100%',}}>
                <View style={{flexDirection:'row', gap:3}}>
                <MaterialCommunityIcons style={{ alignSelf: 'center' }} name="timer" size={20} color="black" />
                <Text style={{fontSize: 14,color:'gray'}}>Unanswered</Text>
                </View>
            ...
            <Text style={{alignSelf: 'center'}}>You are submitting the quiz</Text>
